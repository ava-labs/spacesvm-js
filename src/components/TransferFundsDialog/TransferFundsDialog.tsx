...
export const TransferFundsDialog = ({ open, handleClose }: TransferFundsDialogProps) => {
				...
				<Box sx={{ mt: 4, display: 'flex', justifyContent: 'center' }}>
					...
					>
						<Box sx={{ cursor: !isValidToAddress || transferAmount <= 0 ? 'help' : 'inherit' }}>
							<SubmitButton disabled={!isValidToAddress} variant="contained" type="submit" onClick={onSubmit}>
								{isSigning ? (
									<Fade in={isSigning}>
